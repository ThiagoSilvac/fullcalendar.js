...
var FullCalendar = (function (e) {
    ...
    var vs = (function (e) {
			...
			t.prototype.handleMouseDown = function (e) {
				if (this.rootEl) {
					isDragging = true;
					offsetX = e.clientX - this.rootEl.getBoundingClientRect().left;
					offsetY = e.clientY - this.rootEl.getBoundingClientRect().top;
				}
			};

			t.prototype.handleMouseMove = function (e) {
				if (isDragging && this.rootEl) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return _o(ss, { date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraHookProps: e.extraHookProps, defaultContent: rl }, function (n, o) {
                    return (o || e.forceDayTop) && _o("div", { className: "fc-daygrid-day-top", ref: n }, _o("a", r({ id: e.dayNumberId, className: "fc-daygrid-day-number" }, t), o || _o(xo, null, "Â ")));
                });
            }),
            t
        );
